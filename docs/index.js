...
var ASM_CONSTS = {
  88654: () => { if (document.fullscreenElement) return 1; },  
 88700: () => { return Module.canvas.width; },  
 88732: () => { return parseInt(Module.canvas.style.width); },  
 88780: () => { document.exitFullscreen(); },  
 88807: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 88879: () => { if (document.fullscreenElement) return 1; },  
 88925: () => { return Module.canvas.width; },  
 88957: () => { return screen.width; },  
 88982: () => { document.exitFullscreen(); },  
 89009: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89203: () => { return window.innerWidth; },  
 89229: () => { return window.innerHeight; },  
 89256: () => { if (document.fullscreenElement) return 1; },  
 89302: () => { return Module.canvas.width; },  
 89334: () => { return parseInt(Module.canvas.style.width); },  
 89382: () => { if (document.fullscreenElement) return 1; },  
 89428: () => { return Module.canvas.width; },  
 89460: () => { return screen.width; },  
 89485: () => { return window.innerWidth; },  
 89511: () => { return window.innerHeight; },  
 89538: () => { if (document.fullscreenElement) return 1; },  
 89584: () => { return Module.canvas.width; },  
 89616: () => { return screen.width; },  
 89641: () => { document.exitFullscreen(); },  
 89668: () => { if (document.fullscreenElement) return 1; },  
 89714: () => { return Module.canvas.width; },  
 89746: () => { return parseInt(Module.canvas.style.width); },  
 89794: () => { document.exitFullscreen(); },  
 89821: ($0) => { Module.canvas.style.opacity = $0; },  
 89859: () => { return screen.width; },  
 89884: () => { return screen.height; },  
 89910: () => { return window.screenX; },  
 89937: () => { return window.screenY; },  
 89964: () => { return window.devicePixelRatio; },  
 90000: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90053: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90104: () => { Module.canvas.style.cursor = 'none'; },  
 90141: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90397: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90448: () => { if (document.pointerLockElement) return 1; },  
 90495: () => { if (document.fullscreenElement) return 1; },  
 90541: () => { return window.innerWidth; },  
 90567: () => { return window.innerHeight; }
};
